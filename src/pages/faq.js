								...
								<div className="ori-faq-tab-btn">
									<ul className="nav nav-tabs" id="myTab" role="tablist">
										<li className="nav-item" role="presentation">
											<button className="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">About Services</button>
										</li>
										<li className="nav-item" role="presentation">
											<button className="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Subscription & Billing</button>
										</li>
										<li className="nav-item" role="presentation">
											<button className="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false">Refund Policy</button>
										</li>
										<li className="nav-item" role="presentation">
								...
								<div className="ori-faq-text-wrapper-content">
									...
									<div className="ori-faq-accordion-area">
										<div className="tab-content" id="myTabContent">
											...
											<div className="tab-pane animated fadeInUp" id="profile" role="tabpanel" aria-labelledby="profile-tab">
												<div className="ori-faq-accordion-item-area">
											...
											<div className="tab-pane animated fadeInUp" id="contact" role="tabpanel" aria-labelledby="contact-tab">
												<div className="ori-faq-accordion-item-area">
											...
											<div className="tab-pane animated fadeInUp" id="support" role="tabpanel" aria-labelledby="support-tab">
												<div className="ori-faq-accordion-item-area">
